...
def scrape_page(page_num):
    url = f"https://www.bu.edu/academics/cfa/courses/{page_num}/"
    try:
...
def main():
    ...
    print(f"\nScraping complete.")
    print(f"Saved {len(all_courses)} total courses to cfa_all_courses.csv")
    print(f"Saved {len(hub_courses)} Hub courses to cfa_hub_courses.csv")
