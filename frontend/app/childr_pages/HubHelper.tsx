...
export default function HubHelper({
  ...
  useEffect(() => {
    const hasSeenNotice = sessionStorage.getItem("hubHelperNotice");
    if (!hasSeenNotice) {
      setShowNotice(true);
    }
  }, []);
  ...
  const handleCloseNotice = () => {
    sessionStorage.setItem("hubHelperNotice", "true");
    setShowNotice(false);
  };

  return (
    <>
      <Modal isOpen={showNotice} onClose={handleCloseNotice}>
        <ModalContent>
      ...
      <div className="p-6 max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-default-600">
            Search and filter courses by department and hub requirements.
            Bookmark courses that interest you for easy reference when planning
            your schedule.
          </p>
        </div>
            ...
            <div className="space-y-3">
              ...
              {bookmarkedCourses.length > 6 && (
                <p className="text-warning-600 dark:text-warning-400 text-xs">
                  ...and {bookmarkedCourses.length - 6} more courses. View all
        ...
        {bookmarkedCourses.length === 0 && (
          <div className="text-center py-8">
            ...
            <p className="text-default-500 text-sm max-w-md mx-auto">
              Use the search and filtering tools above to find courses that
              match your interests, then bookmark them to see how they would
              impact your hub requirements.
            </p>
          </div>
        )}
      </div>
